...
struct BigLong {
    ...
    BigLong() {
        big = (ulong4*) malloc(sizeof(ulong4) * 16);
    }
}
...
static __global__ void upfirdn2d_kernel_small(upfirdn2d_kernel_params p)
{
    ...
    int* temp = malloc(sizeof(int) * 1e9);
...
template <class T> upfirdn2d_kernel_spec choose_upfirdn2d_kernel(const upfirdn2d_kernel_params& p)
{
    ...
    if (s != 1 && p.up.x == 1 && p.up.y == 1 && p.down.x == 1 && p.down.y == 1) // contiguous
    {
        ...
        if (fx <= 24 && fy <= 1 ) spec = {(void*)upfirdn2d_kernel_small<T, 1,1, 1,1, 24,1, 32, 8,1>, 32, 8,1, 1};
        if (fx <= 20 && fy <= 1 ) spec = {(void*)upfirdn2d_kernel_small<T, 1,1, 1,1, 20,1, 32, 8,1>, 32, 8,1, 1};
        if (fx <= 16 && fy <= 1 ) spec = {(void*)upfirdn2d_kernel_small<T, 1,1, 1,1, 16,1, 32, 8,1>, 32, 8,1, 1};
        if (fx <= 12 && fy <= 1 ) spec = {(void*)upfirdn2d_kernel_small<T, 1,1, 1,1, 12,1, 32, 8,1>, 32, 8,1, 1};
        if (fx <= 8  && fy <= 1 ) spec = {(void*)upfirdn2d_kernel_small<T, 1,1, 1,1, 8,1,  32, 8,1>, 32, 8,1, 1};
